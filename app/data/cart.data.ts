...
export const products: IProduct[] = [
  ...
  },
  {
    ...
    slug:'earl-grey-tea',
    price: 2,
    reviews: ['good',  'exellent', 'yeee', 'not bad'],
    rating: 4.8,
    description: "Earl Grey tea is a classic black tea infused with the aromatic essence of bergamot, offering a distinctive and refreshing flavor profile. Its delicate citrus notes make it a popular choice for tea enthusiasts seeking a fragrant and uplifting beverage.",
    images: ["/images/earl-grey-removebg-preview.png"],
    category:['tea']
  },
];
